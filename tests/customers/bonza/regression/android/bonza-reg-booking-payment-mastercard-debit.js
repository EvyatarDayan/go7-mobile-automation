...
let zipcode = 12345;
let cardNumber = '5555 5555 5555 4444';
...
describe('Home', ()=>{
    ...
    it('Add payment details using mastercard debit',async ()=>{
        // Select mastercard debit payment
        await global.clickOn(bonzaReviewBookingPage.main.mastercardDebit)
