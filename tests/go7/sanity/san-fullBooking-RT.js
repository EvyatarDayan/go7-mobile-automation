...
describe('Full booking - RT', () => {
    ...
    it('Select passengers', async () => {
        await global.passengers_selectPassengers(0, 0, 0)
    });
    ...
    it('Select flights and fares', async () => {
        ...
        // ================= Price summary validation =============================================================
            ...
            // Calculate depart + return prices (and convert string to number)
            let departPlusReturnPrice = parseFloat(departPrice) + parseFloat(returnPrice)
            // Add .00 to the flights calculation
            let finalFlightsPrice = departPlusReturnPrice.toFixed(2)
